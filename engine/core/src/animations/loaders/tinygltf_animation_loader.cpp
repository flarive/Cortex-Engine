...
void engine::TinygltfAnimationLoader::loadAnimation(const std::string& animationPath, std::shared_ptr<Model> model)
{
...
void engine::TinygltfAnimationLoader::importBoneAnimation(const std::string& animationPath, std::shared_ptr<Model> model)
{
	...
	float durationSeconds = computeDuration(raw, animation);
...
void engine::TinygltfAnimationLoader::readMissingBones(const tg3_model& gltfModel, const tg3_animation& animation, Model& engineModel)
{
