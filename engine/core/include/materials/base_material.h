...
namespace engine
{
	...
	public:
        ...
        BaseMaterial(const std::vector<Texture>& textures);
        BaseMaterial(const Color& ambientColor);
        BaseMaterial(const Color& ambientColor, const Color& diffuseColor, float shininess = 0.0f);
        BaseMaterial(const Color& ambientColor, const std::string& diffuseTexPath, const std::string& specularTexPath = "", const std::string& normalTexPath = "", const std::string& metallicTexPath = "", const std::string& roughnessTexPath = "", const std::string& aoTexPath = "", const std::string& heightTexPath = "", float shininess = 0.0f);
