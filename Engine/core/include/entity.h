...
namespace engine
{
	...
	struct Plane2
	{
		...
		Plane2(const glm::vec3& p1, const glm::vec3& norm)
	...
	struct BoundingVolume
	{
		...
		virtual bool isOnOrForwardPlane(const Plane2& plane) const = 0;
	...
	struct SphereVolume : public BoundingVolume
	{
		...
		bool isOnOrForwardPlane(const Plane2& plane) const final
		{
