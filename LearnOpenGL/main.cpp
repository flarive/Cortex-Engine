...
int main()
{
    ...
    // load shaders
    shader lightingShader("shaders/shader.vertex", "shaders/shader.frag"); // scene cube shader
	shader lightCubeShader("light_cube.vertex", "light_cube.frag"); // light cube shader
