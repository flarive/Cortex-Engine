...
void engine::OpenGLDebug::checkGLError(const char* label)
{
    GLenum err;
...
void engine::OpenGLDebug::GLClearError()
{
    while (glGetError() != GL_NO_ERROR);
}

void engine::OpenGLDebug::GLCheckError()
{
...
void APIENTRY engine::OpenGLDebug::debugMessage(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const GLchar* message, const void* userParam)
{
