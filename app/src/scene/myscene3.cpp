#include "../../include/scene/myscene3.h"

using namespace std;
using namespace glm;
using namespace engine;

MyScene3::MyScene3(const string& _title, std::weak_ptr<App> _app) : Scene(_title, _app, SceneSettings
    {
...
void MyScene3::init()
{
    ...
    auto camera1 = make_shared<FlyCamera>(75.0f, -90.0f, 0.0f, 10.0f);
    ...
    auto trsPlane = Transform(vec3(0.0f, -15.0f, -15.0f), vec3(12.0f));
    ...
    auto rustedIronMat = make_shared<PBRMaterial>(Color(0.1f),
    ...
    auto wallMat = make_shared<PBRMaterial>(Color(0.1f),
    ...
    wallMat->setNormalIntensity(1.0f);
    wallSphere->setup(wallMat, UvMapping(1.0f));
    ...
    auto bronzeMat = make_shared<PBRMaterial>(Color(0.1f),
    ...
    bronzeSphere->setup(bronzeMat, UvMapping(1.0f));
