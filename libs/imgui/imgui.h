...
namespace ImGui
{
    ...
    //FL !!!!!!!!!!!!!
    IMGUI_API bool          InputTextHeader(const char* label, char* buf, size_t buf_size, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
