...
public:
    ...
    void setup() override
    {
        ...
        // load texture
        m_diffuseMap = texture_helper::soil_load_texture("textures/rusted_metal.jpg", true);
        m_specularMap = texture_helper::soil_load_texture("textures/container2_specular.png", false);
    }
