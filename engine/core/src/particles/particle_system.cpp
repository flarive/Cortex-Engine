...
void engine::ParticleSystem::OnUpdate(float ts)
{
...
void engine::ParticleSystem::OnRender(std::shared_ptr<engine::Camera> camera)
{
	//if (!m_QuadVA)
	//{
	//	float vertices[] = {
	...
	//	m_ParticleShaderViewProj = glGetUniformLocation(m_shader->GetRendererID(), "u_ViewProj");
...
void engine::ParticleSystem::Emit(const ParticleProps& particleProps)
{
